...
>
	<div class="flex" use:clickOutsideAction={closeOnClickOutside}>
		<button
			...
			class="relative flex-shrink-0 overflow-hidden z-10 whitespace-nowrap inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-l-lg hover:bg-gray-200 focus:outline-none"
			type="button"
			role="combobox"
