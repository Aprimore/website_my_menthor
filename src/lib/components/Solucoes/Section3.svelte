	...
	<div class="flex items-center mx-auto text-center space-x-7">
		<div class="relative">
			<div class="mt-10 flex justify-center">
				<p
					class="Exo text-4xl border border-gray-300 shadow-sm size-[4rem] flex justify-center items-center rounded-full bg-white text-[#D4D4ED] font-bold absolute top-1.5"
				>
					1.
				</p>
			</div>
			<div
				class="w-[333px] h-[214px] bg-white flex flex-col justify-center items-center space-y-2 border border-gray-300 shadow-sm"
			>
