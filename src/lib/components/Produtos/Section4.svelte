<script>
	import { arrow_right_svg, clientes_parceiros_1_png, linha_h_5_svg, linha_v_1_svg } from '$lib';
</script>

<section class="w-full items-center relative rounded-lg my-20 bg-[#17193B]">
	<div class=" flex flex-row pt-20">
		...
		<div class="w-1/2"><img src={clientes_parceiros_1_png} alt="" /></div>
	</div>
	<div class=" flex flex-row pt-20">
		<div class="w-1/2"><img src={clientes_parceiros_1_png} alt="" /></div>
		<div class="w-1/2">
