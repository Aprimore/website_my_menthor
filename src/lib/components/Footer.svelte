<script lang="ts">
	import { logo_footer_png } from '$lib';
	import Copyright from './Copyright.svelte';
</script>

<footer class="footer relative z-10 py-20">
		...
		<div class="flex flex-wrap -mx-16">
			<div class="w-full px-4 sm:w-2/3 lg:w-3/12">
				<div class="w-full mb-10">
					...
					<a href="#" class="">suporte@mymenthor.com.br</a>
					<button
						class="btn-agendar flex items-center text-sm font-medium text-black py-4 px-10 mt-5 rounded-lg"
					>
