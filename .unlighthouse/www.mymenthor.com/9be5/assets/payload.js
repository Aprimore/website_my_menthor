			...
			columns: {
				...
				performance: [
					...
					},
					{
						...
						sortKey: 'numericValue',
						tooltip:
							'The speed index is a page load performance metric that shows you how quickly the contents of a page are visibly populated. [Learn more](https://web.dev/speed-index/).',
